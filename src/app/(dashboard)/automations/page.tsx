...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-bold text-slate-500 uppercase tracking-wide">Quick-start templates</h2>
            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-slate-200 bg-white p-4 text-left transition-all hover:border-blue-300 hover:shadow-md"
                >
                  <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-lg bg-blue-50 text-blue-600 group-hover:bg-blue-100">
      ...
      {automations.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-slate-50">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 border border-slate-200">
            <Zap className="h-6 w-6 text-slate-400" />
          </div>
          <p className="mt-3 text-[15px] font-bold text-slate-900">No automations yet</p>
          <p className="mt-1 text-sm font-medium text-slate-500">
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-slate-900 font-bold">{pendingDelete?.name}</span> and its execution
...
function AutomationCard({
  ...
  return (
    <li className="rounded-2xl border border-slate-200 bg-white shadow-sm transition-all hover:border-blue-200 hover:-translate-y-0.5 hover:shadow-md">
      <div className="flex items-center gap-4 p-4">
        ...
        >
          ...
          {automation.description && (
            <p className="mt-0.5 truncate text-xs font-medium text-slate-500">{automation.description}</p>
          )}
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-md text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-900 data-[popup-open]:bg-slate-100"
            >

  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_380px] mt-4">
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Button
                  ...
                  disabled={resetting}
                  size="sm"
                  className="mt-3 bg-amber-600 hover:bg-amber-700 text-slate-900"
                >
                  {resetting ? (
                    <>
        ...
        {/* Connection Status */}
        <Alert className="bg-white shadow-sm border-slate-200">
          <div className="flex items-center gap-2">
            ...
            <AlertTitle className="text-slate-900 mb-0">
        ...
        <Card className="bg-white shadow-sm border-slate-200 ring-0 ring-transparent">
          <CardHeader>
            <CardTitle className="text-slate-900">API Credentials</CardTitle>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label className="text-slate-600">Phone Number ID</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-slate-600">WhatsApp Business Account ID</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-slate-600">Permanent Access Token</Label>
              <div className="relative">
                <Input
                  ...
                  className="bg-slate-50 border-slate-200 text-slate-900 placeholder:text-slate-400 pr-10"
                />
                <button
                  type="button"
                  onClick={() => setShowToken(!showToken)}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-900 transition-colors"
                >
            ...
            <div className="space-y-2">
              <Label className="text-slate-600">Webhook Verify Token</Label>
              <Input
        ...
        <Card className="bg-white shadow-sm border-slate-200 ring-0 ring-transparent">
          ...
          <CardContent>
            <div className="space-y-2">
              <Label className="text-slate-600">Webhook Callback URL</Label>
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="shrink-0 border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-50"
                >
      ...
      <div>
        <Card className="bg-white shadow-sm border-slate-200 ring-0 ring-transparent">
          <CardHeader>
            <CardTitle className="text-slate-900 text-base">Setup Instructions</CardTitle>
            <CardDescription className="text-slate-500">

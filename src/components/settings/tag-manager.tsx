  ...
  return (
    <div className="space-y-4 mt-4">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="bg-white shadow-sm border-slate-200 sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-slate-900">New Tag</DialogTitle>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="bg-white shadow-sm border-slate-200 sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-slate-900">Delete Tag</DialogTitle>
            <DialogDescription className="text-slate-500">

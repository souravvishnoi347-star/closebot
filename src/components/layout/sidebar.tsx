  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center justify-between gap-2 border-b border-slate-200 px-6">
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={cn(
                      ...
                      "flex items-center gap-3 rounded-xl px-3 py-2.5 text-[14px] font-semibold transition-colors lg:py-2.5",
                      isActive
        ...
        <div className="shrink-0 border-t border-slate-200 p-4">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex w-full items-center gap-3 rounded-xl px-3 py-2 text-left transition-colors hover:bg-slate-50 focus:bg-slate-50 focus:outline-none data-[state=open]:bg-slate-50">

...
export function PipelineSettings({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-white shadow-sm border-slate-200 max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-slate-900">Manage Pipeline</DialogTitle>
        </DialogHeader>
        ...
        {showDeleteConfirm ? (
          ...
          <>
            <div className="grid gap-4 py-2">
              ...
              <div className="grid gap-2">
                <Label className="text-slate-600">Stages</Label>
                <DndContext
                  sensors={sensors}
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className="border-slate-200 bg-slate-50 text-sm text-slate-900"
                    onKeyDown={(e) => {
                  ...
                  <Button
                    ...
                    className="shrink-0 border-slate-200 bg-transparent text-slate-600 hover:bg-slate-50"
                  >
            ...
            <DialogFooter className="border-slate-200 bg-white shadow-sm/50">
              <Button
                variant="destructive"
  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className="h-7 flex-1 border-transparent bg-transparent text-sm text-slate-900 focus:border-slate-600"
      />
      <Button
        variant="ghost"
        size="icon-xs"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-6 z-20 flex flex-wrap gap-1 rounded-lg border border-slate-200 bg-white shadow-sm p-2 shadow-lg w-36">
            {colors.map((c) => (
              <button
                key={c}
                type="button"

...
export function PipelineAnalytics({ stages, deals }: PipelineAnalyticsProps) {
  ...
  return (
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:grid-cols-3 xl:grid-cols-6">
        <Metric
...
function Metric({
  ...
  return (
    <div className="rounded-xl border border-slate-100 bg-slate-50 p-3">
          ...
          <TooltipTrigger
            render={
              <button
                ...
                className="ml-auto text-slate-500 hover:text-slate-600 focus:outline-none"
              />
            }
          >
      ...
      <p className="mt-1 text-[15px] font-bold text-slate-900">{value}</p>
    </div>
  );
}

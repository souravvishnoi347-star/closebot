...
const DOODLE_BG_CLASSES =
  "bg-slate-50 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEiIGZpbGw9IiNlMmU4ZjAiLz48L3N2Zz4=')] bg-repeat";
...
export function MessageThread({
  ...
  if (!conversation || !contact) {
    return (
      <div className={cn("flex flex-1 flex-col items-center justify-center relative", DOODLE_BG_CLASSES)}>
  ...
  return (
    <div className={cn("flex flex-1 flex-col relative", DOODLE_BG_CLASSES)}>
      {/* Header */}
      <div className="flex h-[72px] items-center justify-between gap-2 border-b border-slate-200 bg-white px-3 py-3 sm:px-6 shadow-sm z-10 shrink-0">
        <div className="flex min-w-0 items-center gap-2 sm:gap-4">
          ...
          {onBack && (
            <button
              ...
              className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-slate-500 hover:bg-slate-50 hover:text-primary lg:hidden transition-colors"
            >
              <ArrowLeft className="h-5 w-5" />
            </button>
          )}
          <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 text-sm font-bold text-blue-700 border border-slate-200">
          ...
          <Badge
            variant="outline"
            className={cn(
              "ml-1 hidden gap-1 border border-slate-200 text-[10px] sm:inline-flex sm:ml-2 bg-white",
              sessionInfo.expired ? "text-red-500 bg-red-50 border-red-200" : "text-emerald-700 bg-emerald-100 border-emerald-200"
            )}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          {onRefresh && (
            <button
              ...
              title="Refresh"
              className={cn(
                "inline-flex h-8 w-8 items-center justify-center rounded-md text-slate-500 transition-colors hover:bg-slate-100 hover:text-primary disabled:opacity-60",
              )}
            >
              <RefreshCw
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className={cn(
                  "inline-flex items-center justify-center h-8 gap-1 px-3 text-xs font-medium rounded-md hover:bg-slate-100 transition-colors",
            ...
            >
              {STATUS_OPTIONS.map((opt) => (
                <DropdownMenuItem
                  ...
                  className={cn("text-sm cursor-pointer hover:bg-slate-50", opt.color)}
                >
                  {opt.label}
                </DropdownMenuItem>
              ))}
                  ...
                  return (
                    <DropdownMenuItem
                      ...
                      className={cn(
                        ...
                        isSelected ? "text-primary font-medium" : "text-slate-600"
                      )}
                    >
              ...
              {assignedAgentId && (
                <>
                  ...
                  <DropdownMenuItem
                    ...
                    className="text-sm text-slate-500 cursor-pointer hover:bg-slate-50"
                  >
                    Unassign
                  </DropdownMenuItem>
                </>
            ...
            {messageGroups.map((group) => (
              <div key={group.date}>
                ...
                <div className="mb-4 flex items-center justify-center">
                  <span className="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-medium text-slate-500 border border-slate-200 shadow-sm">
